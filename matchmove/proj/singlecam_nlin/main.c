...
int main( int argc, char **argv )
{
 ...
 gsl_matrix_set( k, 0, 1, 0 );
 ba_r_to_axis_angle( r_vec, r );
 singlecam_set_krt( x, k, r_vec, t );
 singlecam_nlin_calib( xout, x, points, projs );
 singlecam_get_krt( k, r_vec, t, xout );
 ba_axis_angle_to_r( r, r_vec );
