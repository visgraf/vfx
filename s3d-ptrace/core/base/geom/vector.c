...
Vector4 v4_scale(Real t, Vector4 v)
{
...
Vector4 v4_lerp(Real t, Vector4 a, Vector4 b)
{
  return v4_add(v4_scale((1-t), a), v4_scale((t), b));
}

Vector4 v4_bilerp(Real t, Real lt, Vector4 l0, Vector4 l1,
                          Real rt, Vector4 r0, Vector4 r1)
{
  return v4_lerp(t, v4_lerp(lt, l0, l1), v4_lerp(rt, r0, r1));
}
...
Bool b3_inside(Box3d b, Vector3 p)
{
